...
The next step was turn the military data into parquet. 4,9 GB of data were reduced to 166 MB. In other words, the GB data was reduced 96,61\%. As the new transformed data is only 3,39\% of the original data, Polars can handle it.
