...
Python foi a linguagem escolhida para o análise de dados. As bibliotecas Polars, Matplotlib, Scikit-learn e Statsmodels foram usadas para a análise dos dados inicial, geração das figuras e análise de dados com ML, e para a predição da população brasileira além de 2070 até   2100, respectivamente. A versao do Python usada foi o 3.13.11. 
...
Caso Python não seja suficiente para lidar com os arquivos, usar-se-á o Apache Spark na sua versão Python via a plataforma Databricks, constante na URL \url{https://www.databricks.com/br}.

Nos casos em que o Databrick foi usado, a etapa de ETL (Extract-Transform-Load) ocorreu nele, e com os dados transformados e adequados, transformou-se os arquivos grandes e pesados para o tipo parquet. A mudança promete redução de, no mínimo, 90\% do tamanho original. 
...
[FALAR DOS DADOS DO SERVIÇO MILITAR]
...
Com a abordagem estatística do SARIMA, será prevista a parcela populacional masculina sob a tutela legal do serviço militar, ativo ou da reserva de 2071 até 2100, ou seja, 71 anos de dados serão usados para prever 30.
