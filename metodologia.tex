...
A escolha reflete as etapas usadas fundamentais e imprescindíveis para a análise de dados: ETL, EDA e ML.

Como passo incial o ETL (Extract-Transform-Load)  engloba a extração dos dados de sua fonte, as transformaçoes necessários para esses estejam funcionais e o seu carregamento para a etapa seguinte, a EDA. 
...
Os dados usados para o desenvolvimento das figuras foi retirado do Instituto Brasileiro de Geografia e Estatística (IBGE)\footnote{\url{https://www.ibge.gov.br/estatisticas/sociais/populacao/9109-projecao-da-populacao.html}}. Este fez a projeção da população brasileira desde o ano 2000 até 2070,com a última atualizção da projeção em 2024.
